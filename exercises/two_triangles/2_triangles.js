...
//    Shows the use of two memory areas (VBOs) and how they
//    are activated just before drawing in render().
//    Two VBOs drawn with the same colors (and "uniform" parameter)
//     
