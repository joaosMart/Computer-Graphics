...
!function(e, t) {
    ...
    , function(e, t, n) {
        ...
        function r(e, t, n) {
            Object.defineProperty(e, t, {
                get: function() {
                    return "RGB" === this.__state.space ? this.__state[t] : (h.recalculateRGB(this, t, n),
                    this.__state[t])
                },
                set: function(e) {
                    "RGB" !== this.__state.space && (h.recalculateRGB(this, t, n),
        ...
        function a(e, t) {
            Object.defineProperty(e, t, {
                get: function() {
                    return "HSV" === this.__state.space ? this.__state[t] : (h.recalculateHSV(this),
                    this.__state[t])
                },
                set: function(e) {
                    "HSV" !== this.__state.space && (h.recalculateHSV(this),
        ...
        Object.defineProperty(h.prototype, "hex", {
            get: function() {
                return "HEX" !== !this.__state.space && (this.__state.hex = d["default"].rgb_to_hex(this.r, this.g, this.b)),
                this.__state.hex
            },
            set: function(e) {
          ...
          , _ = function(e) {
            function t(n, o, a) {
                ...
                var l = r(this, e.call(this, n, o))
                  , s = a
                  , u = l;
                return l.__select = document.createElement("select"),
                f["default"].isArray(s) && !function() {
                    var e = {};
            ...
            ,
            t.prototype.updateDisplay = function() {
                return d["default"].isActive(this.__select) ? this : (this.__select.value = this.getValue(),
                e.prototype.updateDisplay.call(this))
            }
            ,
            t
    ...
    , function(e, t, n) {
        ...
        var l = n(7)
          ...
          , c = function(e) {
            ...
            return a(t, e),
            t.prototype.updateDisplay = function() {
                return d["default"].isActive(this.__input) || (this.__input.value = this.getValue()),
                e.prototype.updateDisplay.call(this)
            }
            ,
            t
        ...
        var s = n(7)
          ...
          , f = function(e) {
            function t(n, o, a) {
                ...
                var s = r(this, e.call(this, n, o))
                  , u = a || {};
                return s.__min = u.min,
                s.__max = u.max,
                s.__step = u.step,
                c["default"].isUndefined(s.__step) ? 0 === s.initialValue ? s.__impliedStep = 1 : s.__impliedStep = Math.pow(10, Math.floor(Math.log(Math.abs(s.initialValue)) / Math.LN10)) / 10 : s.__impliedStep = s.__step,
          ...
          , p = function(e) {
            function t(n, o, a) {
                ...
                c["default"].bind(h.__input, "keydown", function(e) {
                    13 === e.keyCode && (m.__truncationSuspended = !0,
                    this.blur(),
            ...
            return a(t, e),
            t.prototype.updateDisplay = function() {
                return this.__input.value = this.__truncationSuspended ? this.getValue() : l(this.getValue(), this.__precision),
                e.prototype.updateDisplay.call(this)
            }
            ,
            t
          ...
          , f = function(e) {
            function t(n, o, a, s, u) {
                ...
                function f(e) {
                    ...
                    return h.setValue(l(e.clientX, t.left, t.right, h.__min, h.__max)),
                    !1
                }
                function _() {
                ...
                var p = r(this, e.call(this, n, o, {
                  ...
                  , h = p;
                return p.__background = document.createElement("div"),
        ...
        var l = n(7)
          ...
          , c = function(e) {
            function t(n, o, a) {
                ...
                var l = r(this, e.call(this, n, o))
                  , s = l;
                return l.__button = document.createElement("div"),
        ...
        var u = n(7)
          ...
          , v = function(e) {
            function t(n, o) {
                ...
                function d() {
                    var e = (0,
                    m["default"])(this.value);
                    e !== !1 ? (y.__color.__state = e,
                    y.setValue(y.__color.toOriginal())) : this.value = y.__color.toString()
                }
                function c() {
    ...
    , function(e, t, n) {
        ...
        function a(e, t, n) {
            ...
            n instanceof B["default"])
                !function() {
                    ...
                    n.domElement.insertBefore(e.domElement, n.domElement.firstElementChild)
                }();
                ...
                })) : n instanceof j["default"] && (z["default"].addClass(t, "color"),
            ...
            n.setValue = U["default"].compose(function(t) {
                return e.getRoot().__preset_select && n.isModified() && r(e.getRoot(), !0),
                t
            }, n.setValue)
        }
        function l(e, t) {
        ...
        function s(e, t, n, o) {
            ...
            z["default"].addClass(u, "property-name"),
            u.innerHTML = r.property;
            var d = document.createElement("div");
            d.appendChild(u),
            d.appendChild(r.domElement);
            var c = i(e, d, o.before);
            return z["default"].addClass(c, oe.CLASS_CONTROLLER_ROW),
            r instanceof j["default"] ? z["default"].addClass(c, "color") : z["default"].addClass(c, g(r.getValue())),
            a(e, c, r),
        ...
        function f(e) {
            ...
            n.innerHTML = "&nbsp;",
            z["default"].addClass(n, "button gears");
            ...
            q && !function() {
                ...
                "true" === localStorage.getItem(u(e, "isLocal")) && n.setAttribute("checked", "checked"),
                c(e, t),
        ...
        var Y = "dg"
          ...
          , oe = function ie(e) {
            ...
            o.autoPlace && U["default"].isUndefined(o.scrollable) && (o.scrollable = !0);
            ...
            if (Object.defineProperties(this, {
                ...
                closed: {
                    ...
                    set: function(e) {
                        o.closed = e,
                        o.closed ? z["default"].addClass(n.__ul, ie.CLASS_CLOSED) : z["default"].removeClass(n.__ul, ie.CLASS_CLOSED),
                        this.onResize(),
                        n.__closeButton && (n.__closeButton.innerHTML = e ? ie.TEXT_OPEN : ie.TEXT_CLOSED)
                    }
                },
                load: {
                    get: function() {
                ...
                useLocalStorage: {
                    ...
                    set: function(e) {
                        q && (r = e,
                        e ? z["default"].bind(window, "unload", a) : z["default"].unbind(window, "unload", a),
            ...
            U["default"].isUndefined(o.parent)) {
                ...
                z["default"].addClass(this.__closeButton, ie.CLASS_CLOSE_BUTTON),
            ...
            o.autoPlace && (U["default"].isUndefined(o.parent) && ($ && (ee = document.createElement("div"),
            ...
            z["default"].bind(this.__ul, "webkitTransitionEnd", this.__resizeHandler),
        ...
        U["default"].extend(oe.prototype, {
            ...
            destroy: function() {
                ...
                this.saveToLocalStorageIfPossible && z["default"].unbind(window, "unload", this.saveToLocalStorageIfPossible)
            },
            addFolder: function(e) {
                ...
                return z["default"].addClass(o, "folder"),
                n
            },
            open: function() {
                this.closed = !1
            ...
            onResize: function() {
                ...
                if (e.scrollable) {
                    ...
                    window.innerHeight - t - W < n ? (z["default"].addClass(e.domElement, oe.CLASS_TOO_TALL),
                    e.__ul.style.height = window.innerHeight - t - W + "px") : (z["default"].removeClass(e.domElement, oe.CLASS_TOO_TALL),
            ...
            remember: function() {
                if (U["default"].isUndefined(Z) && (Z = new F["default"],
            ...
            revert: function(e) {
                U["default"].each(this.__controllers, function(t) {
                    this.getRoot().load.remembered ? l(e || this.getRoot(), t) : t.setValue(t.initialValue),
    ...
    , function(e, t) {
        ...
        t.__esModule = !0,
        t["default"] = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || n
    }
    , function(e, t, n) {
        "use strict";
        function o(e) {
