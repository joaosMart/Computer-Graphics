...
window.onload = function init()
{
    ...
    document.getElementById("Viewpoint").innerHTML = "1: Distant viewpoint";
    document.getElementById("Height").innerHTML = "Additional height:"+ height;
    ...
    window.addEventListener("keydown", function(e){
        switch( e.keyCode ) {
            ...
            case 50: // 2: panning camera inside the track
                view = 2;
                document.getElementById("Viewpoint").innerHTML = "2: View the car from inside the track";
                break;
            case 51: // 3: panning camera inside the track
                view = 3;
                document.getElementById("Viewpoint").innerHTML = "3: View the car from outside the track";
                break;
            ...
            case 53: // 5: drive around while looking at a house
                view = 5;
                document.getElementById("Viewpoint").innerHTML = "5: Always look at one house from inside the car";
                break;
            case 54: // 6: Above and behind the car
                view = 6;
                document.getElementById("Viewpoint").innerHTML = "6: Behind and above the car";
                break;
            case 55: // 7: from another car in front
                view = 7;
                document.getElementById("Viewpoint").innerHTML = "7: View from a car in front";
                break;
            case 56: // 8: from beside the car
                view = 8;
                document.getElementById("Viewpoint").innerHTML = "8: Beside the car";
                break;
            case 57: // 8: from beside the car
                view = 9;
                document.getElementById("Viewpoint").innerHTML = "9: Look at the car from the top of one house";
                break;
            case 38: // up arrow
                height += 2.0;
                document.getElementById("Height").innerHTML = "Additional height: "+ height;
...
function render()
{
    ...
    case 9:
        spinX = 0.0;
        spinY=0.0;
        // View car from the top of the house
        mv = lookAt( vec3(-40., 140.0, 16.0+height), vec3(carXPos, carYPos, 0.0), vec3(0.0, 0.0, 1.0 ) );
        drawScenery( mv );
	    mv = mult( mv, translate(carXPos, carYPos, 0.0) );
	    mv = mult( mv, rotateZ( -carDirection ) ) ;
        drawCar( mv );
